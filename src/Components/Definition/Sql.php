...
/**
 * SQL definition
 * @package VKBansal\Prism\Definition\Sql
 * @version 0.1.0
 * @author Vivek Kumar Bansal <contact@vkbansal.me>
 * @license MIT
 */
class Sql extends AbstractDefinition
{
    /**
     * {@inheritdoc}
     */
    ...
    public function definition()
    {
        return [
            ...
            'operator'=> "/\b(?:ALL|AND|ANY|BETWEEN|EXISTS|IN|LIKE|NOT|OR|IS|UNIQUE|CHARACTER SET|COLLATE|DIV|OFFSET|REGEXP|RLIKE|SOUNDS LIKE|XOR)\b|[-+]{1}|!|[=<>]{1,2}|(&){1,2}|\|?\||\?|\*|\//i",
            'punctuation'=> "/[;[\]()`,.]/"
        ];
    }
}
